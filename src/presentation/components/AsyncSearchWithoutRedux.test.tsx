...
test('AsyncSearchWithoutRedux renders without data', async () => {
    const promise = Promise.resolve();
    const mockIssueInteractor : IssueInteractor = new MockEmptyIssueInteractor();
    const {asFragment} = render(<AsyncSearchWithoutRedux issueInteractor={mockIssueInteractor} />);
...
test('AsyncSearchWithoutRedux renders with data', async () => {
    const promise = Promise.resolve();
...
test('AsyncSearchWithoutRedux autocomplete with data', async () => {
    const promise = Promise.resolve();
    const mockIssueInteractor : IssueInteractor = new MockIssueInteractor();
    render(<AsyncSearchWithoutRedux issueInteractor={mockIssueInteractor} />);
...
test('AsyncSearchWithoutRedux autocomplete without data', async () => {
    const promise = Promise.resolve();
